...
public int save(Ship p){
  String sql="insert into srs_tbl_ship(ShipId,ShipName,SeatingCapacity,ReservationCapacity) values('"+p.getShipId()+"','"+p.getShipName()+"','"+p.getSeatingCapacity()+"','"+p.getReservationCapacity()+"')";
...
public List<Ship> getShipDetails(){
